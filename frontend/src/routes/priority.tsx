...
export const Route = createFileRoute("/priority")({
  head: () => ({
    meta: [
      {
        title: "Priority Scoring — Railway AI Block Planner",
      },
    ],
  }),
  component: Priority,
...
function Priority() {
  ...
  const lookupRisk = async () => {
    ...
    try {
      ...
      if (p === undefined) {
        throw new Error("No probability on record");
      }
  ...
  return (
    <div className="min-w-0 space-y-4 sm:space-y-5">
      ...
      <div className="grid min-w-0 gap-4 sm:gap-5 xl:grid-cols-12">
        <Panel title="Task" className="min-w-0 xl:col-span-7">
          <form onSubmit={onSubmit} className="min-w-0 space-y-4">
            ...
            <div className="min-w-0 rounded-md bg-ink3/40 p-3 hairline sm:p-4">
        ...
        <Panel title="Result" className="min-w-0 xl:col-span-5">
